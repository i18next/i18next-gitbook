...
For a complete example using both App Router and Pages Router with [Locize](https://www.locize.com/i18next?utm_source=i18next_com\&utm_medium=gitbook\&utm_campaign=how_to_caching), have a look at the [next-i18next-locize example](https://github.com/locize/next-i18next-locize).
